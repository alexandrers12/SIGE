...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "teste@teste:123456", "teste@gmail.com:123456"
    };
    /**
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            if(mAuthTask.doInBackground()){
                ...
                CarregaContexto();
                Intent intentVaiProMenuPrincipal = new Intent(LoginActivity.this, PrincipalActivity.class);
                startActivity(intentVaiProMenuPrincipal);
            }
            else{
                Toast.makeText(this, R.string.error_invalid_login, Toast.LENGTH_SHORT);
            }
